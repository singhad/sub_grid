...
def plotting(x, pdf, lambda_jeans_cm, n_H, X_H2, X_H2_bar, n_H_bar):
    ...
    plt.xlim(np.log10(1e15), np.log10(1e21))
    plt.ylim(np.log10(1e-3), np.log10(1e8))
    plt.grid(b=True, which='both', axis='both')
...
if __name__=='__main__':
    ...
    for i in range(1, n_H_range):
        ...
        c_s, lambda_jeans_cm = calc_lambda_jeans(T_mean, n_H)
    ...
    plotting(s, pdf, lambda_jeans_cm, n_H, X_H2, X_H2_bar, n_H_bar)
