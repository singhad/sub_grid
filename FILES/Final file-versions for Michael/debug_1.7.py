...
# USING LTE+PDF EVOLUTION TO CALCULATE X_H2_BAR, X_CO_BAR, l_CO_BAR
...
#     print (x_0)
    ...
    np.save('outputs/debug_1.7/X_H2_bar_' + run + '_' + out + '.npy', \
            X_H2_bar_cells)
    np.save('outputs/debug_1.7/X_CO_bar_' + run + '_' + out + '.npy', \
            X_CO_bar_cells)
    np.save('outputs/debug_1.7/mach_no_arr_' + run + '_' + out + '.npy', \
            mach_no_sim)
    np.save('outputs/debug_1.7/n_H_mean_arr_' + run + '_' + out + '.npy', \
            n_H_mean_sim)
    np.save('outputs/debug_1.7/metal_arr_' + run + '_' + out + '.npy', metal_arr)
    np.save('outputs/debug_1.7/T_' + run + '_' + out + '.npy', temperature)
    np.save('outputs/debug_1.7/l_CO_bar_1' + run + '_' + out + '.npy', \
            l_CO_bar_1_cells)
    np.save('outputs/debug_1.7/l_CO_SI_bar_1' + run + '_' + out + '.npy', \
            l_CO_SI_bar_1_cells)
    np.save('outputs/debug_1.7/l_CO_bar_2' + run + '_' + out + '.npy', \
            l_CO_bar_2_cells)
    np.save('outputs/debug_1.7/l_CO_SI_bar_2' + run + '_' + out + '.npy', \
            l_CO_SI_bar_2_cells)
    np.save('outputs/debug_1.7/m_H2_bar_' + run + '_' + out + '.npy', \
            m_H2_bar_cells) 
    np.save('outputs/debug_1.7/mass_' + run + '_' + out + '.npy', mass)
