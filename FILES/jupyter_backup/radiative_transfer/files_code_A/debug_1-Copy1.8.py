...
def inside_loop(mach_no, n_H_mean, metal, G_o, T_mean, m_p, K_b, 
    ...
    l_CO_bar_1 = np.sum(l_CO_1*pdf_prime*ds)         #luminosity density
    l_CO_SI_bar_1 = np.sum(l_CO_SI_1*pdf_prime*ds)   #luminosity density
    l_CO_bar_2 = np.sum(l_CO_2*pdf_prime*ds)         #luminosity density
    l_CO_SI_bar_2 = np.sum(l_CO_SI_2*pdf_prime*ds)   #luminosity density
