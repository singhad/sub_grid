...
if __name__=='__main__':
    ...
    np.save('outputs/3.1/X_H2_bar_3.1.npy', X_H2_bar)
    np.save('outputs/3.1/X_CO_bar_3.1.npy', X_CO_bar)
    np.save('outputs/3.1/mach_no_arr_3.1.npy', mach_no_arr)
    np.save('outputs/3.1/n_H_mean_arr_3.1.npy', n_H_mean_arr)
    np.save('outputs/3.1/Z_arr_3.1.npy', Z_arr)