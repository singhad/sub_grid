...
if __name__=='__main__':
    ...
    np.save('outputs/3.6/X_H2_bar_3.6.npy', X_H2_bar)
    np.save('outputs/3.6/X_CO_bar_3.6.npy', X_CO_bar)
    np.save('outputs/3.6/mach_no_arr_3.6.npy', mach_no_arr)
    np.save('outputs/3.6/n_H_mean_arr_3.6.npy', n_H_mean_arr)
    np.save('outputs/3.6/Z_arr_3.6.npy', Z_arr)