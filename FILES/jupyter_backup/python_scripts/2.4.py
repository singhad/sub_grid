...
if __name__=='__main__':
    ...
    np.save('outputs/2.4/X_H2_bar_2.4.npy', X_H2_bar)
    np.save('outputs/2.4/X_CO_bar_2.4.npy', X_CO_bar)
    np.save('outputs/2.4/mach_no_arr_2.4.npy', mach_no_arr)
    np.save('outputs/2.4/n_H_mean_arr_2.4.npy', n_H_mean_arr)
    np.save('outputs/2.4/Z_arr_2.4.npy', n_H_mean_arr)
