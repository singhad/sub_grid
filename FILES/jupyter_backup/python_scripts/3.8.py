...
if __name__=='__main__':
    ...
    np.save('outputs/3.8/X_H2_bar_3.8.npy', X_H2_bar)
    np.save('outputs/3.8/X_CO_bar_3.8.npy', X_CO_bar)
    np.save('outputs/3.8/mach_no_arr_3.8.npy', mach_no_arr)
    np.save('outputs/3.8/n_H_mean_arr_3.8.npy', n_H_mean_arr)
    np.save('outputs/3.8/Z_arr_3.8.npy', Z_arr)
    np.save('outputs/3.8/T_3.8.npy', temperature)