...
if __name__=='__main__':
    ...
    np.save('outputs/2.0/X_H2_bar_2.0.npy', X_H2_bar)
    np.save('outputs/2.0/X_CO_bar_2.0.npy', X_CO_bar)
    np.save('outputs/2.0/mach_no_arr_2.0.npy', mach_no_arr)
    np.save('outputs/2.0/n_H_mean_arr_2.0.npy', n_H_mean_arr)
    np.save('outputs/2.0/Z_arr_2.0.npy', n_H_mean_arr)
