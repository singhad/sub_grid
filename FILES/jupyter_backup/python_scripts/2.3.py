...
if __name__=='__main__':
    ...
    np.save('outputs/2.3/X_H2_bar_2.3.npy', X_H2_bar)
    np.save('outputs/2.3/X_CO_bar_2.3.npy', X_CO_bar)
    np.save('outputs/2.3/mach_no_arr_2.3.npy', mach_no_arr)
    np.save('outputs/2.3/n_H_mean_arr_2.3.npy', n_H_mean_arr)
    np.save('outputs/2.3/Z_arr_2.3.npy', n_H_mean_arr)
