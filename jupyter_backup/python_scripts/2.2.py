...
if __name__=='__main__':
    ...
    np.save('outputs/2.2/X_H2_bar_2.2.npy', X_H2_bar)
    np.save('outputs/2.2/X_CO_bar_2.2.npy', X_CO_bar)
    np.save('outputs/2.2/mach_no_arr_2.2.npy', mach_no_arr)
    np.save('outputs/2.2/n_H_mean_arr_2.2.npy', n_H_mean_arr)
    np.save('outputs/2.2/Z_arr_2.2.npy', n_H_mean_arr)
