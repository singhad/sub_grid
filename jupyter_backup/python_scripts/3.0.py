...
if __name__=='__main__':
    ...
    np.save('outputs/3.0/X_H2_bar_3.0.npy', X_H2_bar)
    np.save('outputs/3.0/X_CO_bar_3.0.npy', X_CO_bar)
    np.save('outputs/3.0/mach_no_arr_3.0.npy', mach_no_arr)
    np.save('outputs/3.0/n_H_mean_arr_3.0.npy', n_H_mean_arr)
    np.save('outputs/3.0/Z_arr_3.0.npy', Z_arr)