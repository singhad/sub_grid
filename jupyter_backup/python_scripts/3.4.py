...
#     X_CO_bar = np.zeros(len(n_H_mean_arr))
    ...
    np.save('outputs/3.4/s_3.4.npy', s)
    np.save('outputs/3.4/n_H_3.4.npy', n_H)
    np.save('outputs/3.4/pdf_3.4.npy', pdf)
    np.save('outputs/3.4/lambda_jeans_3.4.npy', lambda_jeans)
    np.save('outputs/3.4/n_LW_3.4.npy', n_LW)
    np.save('outputs/3.4/n_H2_3.4.npy', n_H2)
    np.save('outputs/3.4/n_LW_ss_3.4.npy', n_LW_ss)
    np.save('outputs/3.4/X_H2_ss_3.4.npy', X_H2_ss)
    np.save('outputs/3.4/n_H2_ss_3.4.npy', n_H2_ss)
    np.save('outputs/3.4/X_CO_3.4.npy', X_CO)
    np.save('outputs/3.4/n_CO_3.4.npy', n_CO)
    np.save('outputs/3.4/c_s_arr_3.4.npy', c_s_arr)
    np.save('outputs/3.4/mach_no_arr_3.4.npy', mach_no_arr)
    np.save('outputs/3.4/n_H_mean_arr_3.4.npy', n_H_mean_arr)
    np.save('outputs/3.4/Z_arr_3.4.npy', Z_arr)