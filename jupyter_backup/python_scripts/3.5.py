...
if __name__=='__main__':
    ...
    np.save('outputs/3.5/X_H2_bar_3.5.npy', X_H2_bar)
    np.save('outputs/3.5/X_CO_bar_3.5.npy', X_CO_bar)
    np.save('outputs/3.5/mach_no_arr_3.5.npy', mach_no_arr)
    np.save('outputs/3.5/n_H_mean_arr_3.5.npy', n_H_mean_arr)
    np.save('outputs/3.5/Z_arr_3.5.npy', Z_arr)