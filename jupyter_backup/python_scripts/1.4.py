...
if __name__=='__main__':
    ...
    np.save('outputs/X_H2_bar_1.4.npy', X_H2_bar)
    np.save('outputs/X_CO_bar_1.4.npy', X_CO_bar)
    np.save('outputs/mach_no_arr_1.4.npy', mach_no_arr)
    np.save('outputs/n_H_mean_arr_1.4.npy', n_H_mean_arr)
    np.save('outputs/Z_arr_1.4.npy', n_H_mean_arr)
