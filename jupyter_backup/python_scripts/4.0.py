...
if __name__=='__main__':
    ...
    np.save('outputs/4.0/X_H2_bar_4.0.npy', X_H2_bar)
    np.save('outputs/4.0/X_CO_bar_4.0.npy', X_CO_bar)
    np.save('outputs/4.0/mach_no_arr_4.0.npy', mach_no_arr)
    np.save('outputs/4.0/n_H_mean_arr_4.0.npy', n_H_mean_arr)
    np.save('outputs/4.0/Z_arr_4.0.npy', Z_arr)
    np.save('outputs/4.0/T_4.0.npy', temperature)