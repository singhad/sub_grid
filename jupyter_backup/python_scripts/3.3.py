...
if __name__=='__main__':
    ...
    np.save('outputs/3.3/X_H2_bar_3.3.npy', X_H2_bar)
    np.save('outputs/3.3/X_CO_bar_3.3.npy', X_CO_bar)
    np.save('outputs/3.3/mach_no_arr_3.3.npy', mach_no_arr)
    np.save('outputs/3.3/n_H_mean_arr_3.3.npy', n_H_mean_arr)
    np.save('outputs/3.3/Z_arr_3.3.npy', Z_arr)