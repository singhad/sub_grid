...
if __name__=='__main__':
    ...
    np.save('outputs/2.5/X_H2_bar_2.5.npy', X_H2_bar)
    np.save('outputs/2.5/X_CO_bar_2.5.npy', X_CO_bar)
    np.save('outputs/2.5/mach_no_arr_2.5.npy', mach_no_arr)
    np.save('outputs/2.5/n_H_mean_arr_2.5.npy', n_H_mean_arr)
    np.save('outputs/2.5/Z_arr_2.5.npy', n_H_mean_arr)
