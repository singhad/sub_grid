...
plt.savefig('outputs/1.2/X_H2_bar-n_H_mean-1.2.png', dpi=300, bbox_inches='tight')
plt.show()
...
plt.savefig('outputs/1.2/X_CO_bar-n_H_mean-1.2.png', dpi=300, bbox_inches='tight')
plt.show()
