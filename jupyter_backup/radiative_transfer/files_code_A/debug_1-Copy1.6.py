...
def inside_loop(mach_no, n_H_mean, metal, G_o, T_mean, m_p, K_b, 
    ...
    l_CO_bar_1 = np.sum(l_CO_1*pdf*ds)         #luminosity density
    l_CO_SI_bar_1 = np.sum(l_CO_SI_1*pdf*ds)   #luminosity density
    l_CO_bar_2 = np.sum(l_CO_2*pdf*ds)         #luminosity density
    l_CO_SI_bar_2 = np.sum(l_CO_SI_2*pdf*ds)   #luminosity density
...
#     print (x_0)
    ...
    np.save('outputs/debug_1.6/X_H2_bar_' + run + '_' + out + '.npy', \
            X_H2_bar_cells)
    np.save('outputs/debug_1.6/X_CO_bar_' + run + '_' + out + '.npy', \
            X_CO_bar_cells)
    np.save('outputs/debug_1.6/mach_no_arr_' + run + '_' + out + '.npy', \
            mach_no_sim)
    np.save('outputs/debug_1.6/n_H_mean_arr_' + run + '_' + out + '.npy', \
            n_H_mean_sim)
    np.save('outputs/debug_1.6/metal_arr_' + run + '_' + out + '.npy', metal_arr)
    np.save('outputs/debug_1.6/T_' + run + '_' + out + '.npy', temperature)
    np.save('outputs/debug_1.6/l_CO_bar_1' + run + '_' + out + '.npy', \
            l_CO_bar_1_cells)
    np.save('outputs/debug_1.6/l_CO_SI_bar_1' + run + '_' + out + '.npy', \
            l_CO_SI_bar_1_cells)
    np.save('outputs/debug_1.6/l_CO_bar_2' + run + '_' + out + '.npy', \
            l_CO_bar_2_cells)
    np.save('outputs/debug_1.6/l_CO_SI_bar_2' + run + '_' + out + '.npy', \
            l_CO_SI_bar_2_cells)
    np.save('outputs/debug_1.6/m_H2_bar_' + run + '_' + out + '.npy', \
            m_H2_bar_cells) 
    np.save('outputs/debug_1.6/mass_' + run + '_' + out + '.npy', mass)
