...
#     print (x_0)
    ...
    np.save('outputs/debug_1.3/X_H2_bar_' + run + '_' + out + '.npy', \
            X_H2_bar_cells)
    np.save('outputs/debug_1.3/X_CO_bar_' + run + '_' + out + '.npy', \
            X_CO_bar_cells)
    np.save('outputs/debug_1.3/mach_no_arr_' + run + '_' + out + '.npy', \
            mach_no_sim)
    np.save('outputs/debug_1.3/n_H_mean_arr_' + run + '_' + out + '.npy', \
            n_H_mean_sim)
    np.save('outputs/debug_1.3/metal_arr_' + run + '_' + out + '.npy', metal_arr)
    np.save('outputs/debug_1.3/T_' + run + '_' + out + '.npy', temperature)
    np.save('outputs/debug_1.3/l_CO_bar_' + run + '_' + out + '.npy', \
            l_CO_bar_cells)
    np.save('outputs/debug_1.3/l_CO_SI_bar_' + run + '_' + out + '.npy', \
            l_CO_SI_bar_cells)
    np.save('outputs/debug_1.3/m_H2_bar_' + run + '_' + out + '.npy', \
            m_H2_bar_cells) 
    np.save('outputs/debug_1.3/mass_' + run + '_' + out + '.npy', mass)
