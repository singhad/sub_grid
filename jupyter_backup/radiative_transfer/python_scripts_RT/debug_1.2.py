...
def tau_LVG(n_CO, nu, lambda_jeans, x_1, x_0, B_10, B_01, c_s_CO, c_cgs, h_ev):
    ...
    delta_v = 1e5*((lambda_jeans/3.086e+18)**0.5)
...
if __name__ == '__main__':
    ...
    np.save('outputs/debug_1.2/X_H2_bar_' + run + '_' + out + '.npy', \
            X_H2_bar_cells)
    np.save('outputs/debug_1.2/X_CO_bar_' + run + '_' + out + '.npy', \
            X_CO_bar_cells)
    np.save('outputs/debug_1.2/mach_no_arr_' + run + '_' + out + '.npy', \
            mach_no_sim)
    np.save('outputs/debug_1.2/n_H_mean_arr_' + run + '_' + out + '.npy', \
            n_H_mean_sim)
    np.save('outputs/debug_1.2/metal_arr_' + run + '_' + out + '.npy', metal_arr)
    np.save('outputs/debug_1.2/T_' + run + '_' + out + '.npy', temperature)
    np.save('outputs/debug_1.2/l_CO_bar_' + run + '_' + out + '.npy', \
            l_CO_bar_cells)
    np.save('outputs/debug_1.2/l_CO_SI_bar_' + run + '_' + out + '.npy', \
            l_CO_SI_bar_cells)
    np.save('outputs/debug_1.2/m_H2_bar_' + run + '_' + out + '.npy', \
            m_H2_bar_cells)
    np.save('outputs/debug_1.2/mass_' + run + '_' + out + '.npy', mass)