...
#     print (x_0)
    ...
    np.save('outputs/debug_1.0/X_H2_bar_' + run + '_' + out + '.npy', \
            X_H2_bar_cells)
    np.save('outputs/debug_1.0/X_CO_bar_' + run + '_' + out + '.npy', \
            X_CO_bar_cells)
    np.save('outputs/debug_1.0/mach_no_arr_' + run + '_' + out + '.npy', \
            mach_no_sim)
    np.save('outputs/debug_1.0/n_H_mean_arr_' + run + '_' + out + '.npy', \
            n_H_mean_sim)
    np.save('outputs/debug_1.0/metal_arr_' + run + '_' + out + '.npy', metal_arr)
    np.save('outputs/debug_1.0/T_' + run + '_' + out + '.npy', temperature)
    np.save('outputs/debug_1.0/l_CO_bar_' + run + '_' + out + '.npy', \
            l_CO_bar_cells)
    np.save('outputs/debug_1.0/l_CO_SI_bar_' + run + '_' + out + '.npy', \
            l_CO_SI_bar_cells)
    np.save('outputs/debug_1.0/m_H2_bar_' + run + '_' + out + '.npy', \
            m_H2_bar_cells)
    np.save('outputs/debug_1.0/mass_' + run + '_' + out + '.npy', mass)