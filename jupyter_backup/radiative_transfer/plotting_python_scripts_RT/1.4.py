...
if __name__=='__main__':
    ...
    #radiative_transfer/outputs_RT/1.4/
    np.save('radiative_transfer/outputs_RT/1.4/X_H2_bar_1.4.npy', X_H2_bar)
    np.save('radiative_transfer/outputs_RT/1.4/X_CO_bar_1.4.npy', X_CO_bar)
    np.save('radiative_transfer/outputs_RT/1.4/mach_no_arr_1.4.npy', mach_no_arr)
    np.save('radiative_transfer/outputs_RT/1.4/n_H_mean_arr_1.4.npy', n_H_mean_arr)
    np.save('radiative_transfer/outputs_RT/1.4/metal_arr_1.4.npy', metal_arr)
    np.save('radiative_transfer/outputs_RT/1.4/T_1.4.npy', temperature)
    np.save('radiative_transfer/outputs_RT/1.4/j_nu_bar_1.4.npy', j_nu_bar)