...
#     else:
    ...
    return n_H, n_H2, X_H2, n_LW, n_LW_ss, X_H2_ss, n_H2_ss, X_CO, n_CO, pdf, pdf_prime, lambda_jeans
...
if __name__=='__main__':
    ...
    n_H, n_H2, X_H2, n_LW, n_LW_ss, X_H2_ss, n_H2_ss, X_CO, n_CO, pdf, pdf_prime, lambda_jeans = CO_density(mach_no, 
                                                                                                 n_H_mean, Z, G_o, 
                                                                                                 T_mean, m_p, K_b)
    
    np.save('outputs/sub_grid_evolution/n_H.npy', n_H)
    np.save('outputs/sub_grid_evolution/n_H2.npy', n_H2)
    np.save('outputs/sub_grid_evolution/X_H2.npy', 2*X_H2)
    np.save('outputs/sub_grid_evolution/n_LW.npy', n_LW)
    np.save('outputs/sub_grid_evolution/n_LW_ss.npy', n_LW_ss)
    np.save('outputs/sub_grid_evolution/X_H2_ss.npy', 2*X_H2_ss)
    np.save('outputs/sub_grid_evolution/n_H2_ss.npy', n_H2_ss)
    np.save('outputs/sub_grid_evolution/X_CO.npy', X_CO)
    np.save('outputs/sub_grid_evolution/n_CO.npy', n_CO)
    np.save('outputs/sub_grid_evolution/pdf.npy', pdf)
    np.save('outputs/sub_grid_evolution/pdf_prime.npy', pdf_prime)
    np.save('outputs/sub_grid_evolution/lambda_jeans.npy', lambda_jeans)
